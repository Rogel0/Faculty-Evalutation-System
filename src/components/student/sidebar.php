...
<aside class="bg-slate-800 text-white w-64 h-full lg:h-screen flex flex-col shadow-xl fixed lg:static z-40 transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0" id="studentSidebar">
    ...
    <div class="p-4 border-b border-slate-700 flex items-center justify-between">
        <div class="flex items-center space-x-3">
            ...
            <div>
                ...
                <p class="text-[11px] text-slate-300">Senior High School</p>
                <p class="text-[11px] text-slate-400">ID: <?php echo htmlspecialchars($student_id); ?> | <?php echo htmlspecialchars($student_strand ?? 'Unknown'); ?> Strand</p>
            </div>
        </div>
    ...
    <nav class="flex-1 p-3 space-y-1.5">
        <a href="?module=evaluate_teacher" class="group flex items-center space-x-3 p-2.5 rounded-lg transition-all duration-200 <?php echo ($currentModule === 'evaluate_teacher') ? 'bg-yellow-500 text-gray-900 shadow-lg' : 'text-slate-300 hover:bg-slate-700 hover:text-white'; ?>">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path>
            </svg>
            <span class="font-medium text-sm">Evaluate Teachers</span>
        </a>
