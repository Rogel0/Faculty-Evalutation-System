...
<div class="p-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-4">
            <button id="addSupervisorBtn" class="flex items-center px-5 py-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-lg shadow transition-all duration-200">
    ...
    <div class="flex items-center mb-6">
        <div class="relative w-full max-w-md">
            <form method="GET" action="?module=add_supervisor" id="supervisorSearchForm">
                <input type="hidden" name="module" value="add_supervisor" />
                <?php $search_q = isset($_GET['q']) ? htmlspecialchars($_GET['q']) : ''; ?>
                <input type="text" name="q" id="searchInput" value="<?php echo $search_q; ?>" placeholder="Search supervisor..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 text-gray-900 placeholder-gray-400">
    ...
    <?php include('tables/add_supervisor_table.php'); ?>
    <?php include('drawer/add_supervisor_drawer.php'); ?>
</div>
