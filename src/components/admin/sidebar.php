...
<aside class="bg-slate-700 text-white w-64 min-h-screen flex flex-col shadow-xl">
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="?module=dashboard"
            class="group flex items-center space-x-3 p-3 rounded-lg transition-all duration-200 <?php echo ($currentModule === 'dashboard') ? 'bg-yellow-500 text-gray-900 shadow-lg' : 'text-slate-300 hover:bg-slate-600 hover:text-white'; ?>">
            ...
            <?php if ($currentModule === 'dashboard'): ?>
                <div class="w-1 h-8 bg-white rounded-full ml-auto"></div>
            <?php endif; ?>
        </a>

        <!-- Questionnaire -->
        <a href="?module=questionnaire"
            class="group flex items-center space-x-3 p-3 rounded-lg transition-all duration-200 <?php echo ($currentModule === 'questionnaire') ? 'bg-yellow-500 text-gray-900 shadow-lg' : 'text-slate-300 hover:bg-slate-600 hover:text-white'; ?>">
            <div class="w-5 h-5 flex items-center justify-center">
                <svg fill="currentColor" viewBox="0 0 20 20" class="w-5 h-5">
            ...
            <?php if ($currentModule === 'questionnaire'): ?>
        ...
        <a href="?module=academic-year"
            class="group flex items-center space-x-3 p-3 rounded-lg transition-all duration-200 <?php echo ($currentModule === 'academic-year') ? 'bg-yellow-500 text-gray-900 shadow-lg' : 'text-slate-300 hover:bg-slate-600 hover:text-white'; ?>">
            <div class="w-5 h-5 flex items-center justify-center">
                <svg fill="currentColor" viewBox="0 0 20 20" class="w-5 h-5">
            ...
            <?php if ($currentModule === 'academic-year'): ?>
                <div class="w-1 h-8 bg-gray-900 rounded-full ml-auto"></div>
            <?php endif; ?>
        </a>
