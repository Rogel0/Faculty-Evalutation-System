-- Add REMAINING Teachers for Philippine SHS Departments
-- This script adds only the teachers that haven't been added yet to avoid duplicates
...
-- Additional ICT Teachers (Making sure it's ICT, not IT) - MOST TEACHERS FOR ICT
INSERT INTO
    users (
        username,
        firstname,
...
-- Summary of REMAINING Teachers Added:
-- STEM: 8 teachers total (5 already added + 3 new)
-- ABM: 8 teachers total (5 already added + 3 new)  
-- HUMSS: 9 teachers total (6 new)
-- GAS: 8 teachers total (5 new)
-- ICT: 10 teachers total (5 new + 5 additional) - MOST TEACHERS FOR ICT
-- Core: 10 teachers total (6 new + 4 additional)
-- This script adds 43 NEW teachers to complete the realistic peer evaluation setup
-- Total will be 53 teachers for comprehensive testing